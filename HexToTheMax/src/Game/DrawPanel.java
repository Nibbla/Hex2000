...
public class DrawPanel extends JPanel implements Observer {
   ...
   // public static BufferedImage ballImage;
    ...
    private Game.BoardCoordinate previewMove;
    private Game.BoardCoordinate lastHover = new Game.BoardCoordinate(-1,-1);
    ...
    public DrawPanel() {
        ...
        this.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseMoved(MouseEvent e) {
                Game.BoardCoordinate coordinate = Game.BoardCoordinate.ScreenToBoard(e.getX(),e.getY());
        ...
        Game.DrawPanel dp = this;
        this.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                System.out.println("mouseCordY" + e.getY());

                System.out.println(Game.BoardCoordinate.ScreenToBoard(e.getX(),e.getY()));
    ...
    public static BufferedImage createImageStandart(Board Board) {
        if (grassTexture==null) Game.DrawPanel.loadTextures();
        ...
        Game.Coordinate[][] normals = Board.getSurfaceNormals();
        if (normals == null){
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int j = 1; j<= bs+1;j++){
             Polygon p = Game.BoardCoordinate.getHexPolygon(new Game.BoardCoordinate(i,j));
             g.fillPolygon(p);
        }
        i = bs+1;
        for (int j = 1; j<= bs;j++){
        ...
        if (lastHover.isWithinPlayfield()){
            Polygon p = Game.BoardCoordinate.getHexPolygon(lastHover);
            g.fillPolygon(p);
        }
    }
    ...
    public void setPreviewMove(Game.BoardCoordinate previewMove) {
